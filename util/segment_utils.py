...
def refine_disp_with_segments(disparity, segments, foreground_mask, keep_threshold=7*0.3):
    """
    ...
    for segment in segments:
        ...
        if foreground_mask is not None and (mask & foreground_mask).astype(int).sum() > 30:
            continue
